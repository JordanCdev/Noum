...
struct CoachKnowledgeBaseIntegrityTests {
    ...
    static let bannedPhrases: [String] = [
        ...
        "i don't have rated sessions", "i do not have rated sessions",
        "no rated sessions yet", "we do not have any rated sessions",
        ...
        "from here the coaching", "from this rep forward",
        "the coaching drops", "coaching drops the", "the coaching will",
        "coaching that sounds like a person", "report-voice",
        "speaks to you directly", "nothing templated",
        "generic tip-giving", "i'll cut the markers",
        "i will cut the markers", "cut the markers and the report voice",
        "you are right to call that out, as",
        "i am cutting the", "i'm cutting the", "i will cut the report voice",
        "i'll cut the report voice", "i will cut the robotic report voice",
        "i'll cut the robotic report voice", "you are right to call that out",
        "you're right to call that out", "your brain",
        "brain was searching", "searching for the next word",
