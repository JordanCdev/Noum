...
enum CoachKnowledgeBase {
    ...
    private static let fillerCards: [CoachKnowledgeCard] = [
        CoachKnowledgeCard(
            ...
            why: "a filler fills the moment before the next word arrives; a silence does the same job and reads as composure instead of nerves",
        ...
        CoachKnowledgeCard(
            ...
            why: "fillers spike when the next connector is not ready, so giving yourself one in advance removes the reason to reach for um",
        ...
        CoachKnowledgeCard(
            ...
            why: "fillers often spike in the first few seconds, before you have found your footing",
