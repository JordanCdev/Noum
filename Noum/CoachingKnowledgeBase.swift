...
enum CoachKnowledgeBase {
    ...
    private static let fillerCards: [CoachKnowledgeCard] = [
        CoachKnowledgeCard(
            ...
            why: "a filler fills the gap your brain needs to find the next word; a silence does the same job and reads as composure instead of nerves",
            howToApply: "the next time an um or uh wants to come out, close your mouth and hold a one-second silence instead, then speak",
            successMarker: "the gaps go quiet rather than filling with um, and the silence stops feeling like a hole",
        ...
        CoachKnowledgeCard(
            ...
            why: "fillers spike when the brain is searching for the next connector, so giving it a ready one removes the reason to reach for um",
            ...
            successMarker: "transitions sound deliberate and the um count at sentence joins drops",
        ...
        CoachKnowledgeCard(
            ...
            why: "fillers spike under retrieval load, and load is highest in the first few seconds before you've found your footing",
            howToApply: "say your first sentence slower than feels natural — give yourself room to find the second one before the gap turns into an um",
            successMarker: "the first fifteen seconds carry far fewer fillers than they used to",
    ...
    private static let composureCards: [CoachKnowledgeCard] = [
        ...
        CoachKnowledgeCard(
            ...
            why: "a beat before answering a hard question reads as command, not hesitation, and buys you the moment to choose your first sentence",
            howToApply: "when a tough question lands, hold a deliberate beat, then open with your actual point — the pause looks like control, not doubt",
    ...
    private static let leadershipCards: [CoachKnowledgeCard] = [
        ...
        CoachKnowledgeCard(
            ...
            domain: .transferLeadership,
            technique: "economy",
            why: "over-explaining leaks uncertainty; saying less and letting it sit reads as command",
        ...
        CoachKnowledgeCard(
            ...
            domain: .transferLeadership,
            technique: "the executive summary",
            why: "a senior room wants the headline and the implication first; the detail is for if they ask",
