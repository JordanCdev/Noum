...
enum CloudProcessorManifest {
    ...
    static let processors: [CloudProcessorDisclosure] = [
        ...
        CloudProcessorDisclosure(
            ...
            data: "Bounded production coaching requests, Authentication and App Check proof, bounded competitive-rep PCM held in invocation memory with server-derived observation metadata and an account-unlinked seven-day exact-audio replay digest, and short-lived mutual-connection invite secrets handled in invocation memory with digest-addressed account, display-name, pair, and timestamp records; account identity, optional sync data, Firebase installation data, and versioned Remote Config values are processed separately for account and configuration functionality",
