...
enum DailyChallengeKind: String, CaseIterable, Codable {
    ...
    var title: String {
        ...
        case .soloAhCounter:            return "Clean Ah Counter round"
        case .timedDeepRep:             return "90-second Timed rep"
        case .suddenDeathSurvivor:      return "60-second Sudden Death run"
    ...
    var subtitle: String {
        ...
        case .suddenDeathSurvivor:      return "Hold Sudden Death for 60 seconds with one filler at most."
        case .imConversationClean:      return "A 30-word IM rep with at most two fillers."
