    ...
    static let all: [(PathNode, PathNodeCriterion)] = [
        ...
        (
            PathNode(
                ...
                order: 2,
                tier: .bronze,
                title: "First Sudden Death",
                detail: "Try the pressure mode at least once.",
                coachLine: "Sudden Death exposes how you handle a clock and a misstep.",
                actionLabel: "Open Sudden Death",
        ...
        (
            PathNode(
                ...
                coachLine: "A single clean rep proves the pause-instead-of-filler instinct is in there.",
                actionLabel: "Start a rep",
                actionDestination: .practiceSelection,
        ...
        (
            PathNode(
                ...
                coachLine: "500 is the line where Pressure Mode starts respecting your decisions.",
        ...
        (
            PathNode(
                ...
                order: 10,
                tier: .gold,
                title: "Sudden Death survivor",
                detail: "Survive into round 3 of a Sudden Death session.",
