    ...
    private static func reduceFillersSteps(_ b: CommunicationBaseline) -> [GoalStep] {
        ...
        return [
            ...
            make(g, 5, "under_pressure", title: "A clean rep under pressure",
                 ...
                 success: "A zero-filler qualifying rep at elevated pressure.", symbol: "bolt.heart", dest: .suddenDeathPractice, action: "Try Pressure Drill",
    ...
    private static func moreConciseSteps(_ b: CommunicationBaseline) -> [GoalStep] {
        ...
        return [
            ...
            make(g, 5, "under_pressure", title: "Stay tight under a hard clock",
                 ...
                 success: "A tight rep at elevated pressure.", symbol: "bolt.heart", dest: .suddenDeathPractice, action: "Try Pressure Drill",
    ...
    private static func thinkFasterSteps(_ b: CommunicationBaseline) -> [GoalStep] {
        ...
        return [
            ...
            make(g, 1, "unscripted", title: "Try an unscripted rep",
                 target: "Run one Pressure Drill rep.", why: "On-the-spot speaking is a muscle — Pressure Drill is where it grows.",
                 success: "One Pressure Drill rep recorded.", symbol: "bolt", dest: .suddenDeathPractice, action: "Try Pressure Drill",
            ...
            make(g, 5, "hold_warmup", title: "Hold past the warm-up",
                 target: "Stay in a Pressure Drill rep past the early rounds.", why: "The first answers are easy — composure shows up a few rounds in.",
                 success: "Survive into the later rounds of a Pressure Drill rep.", symbol: "bolt.heart", dest: .suddenDeathPractice, action: "Try Pressure Drill",
    ...
    private static func calmerDeliverySteps(_ b: CommunicationBaseline) -> [GoalStep] {
        ...
        return [
            ...
            make(g, 5, "under_pressure", title: "Stay composed under a hard clock",
                 ...
                 success: "A composed-pause rep at elevated pressure.", symbol: "bolt.heart", dest: .suddenDeathPractice, action: "Try Pressure Drill",
