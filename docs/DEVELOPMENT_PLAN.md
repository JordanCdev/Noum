...
read, but does not authorize connecting it to the action owner while Summary,
`CoachingPlanner`, and coach-context comparisons remain duration-biased.
