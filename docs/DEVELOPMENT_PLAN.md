...
are removed. The complete unit target passes 4,109/4,109. The next local
correctness slice is Path filler-milestone integrity: persistent unlocks still
need the shared quantity, confidence, schema, and fixture boundary plus an
explicit compatibility decision for already-earned progress.
