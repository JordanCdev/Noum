...
armed-rep guard is byte-exact. A focused 56-test simulator selection and the
unchanged 109 Functions authority plus 6 deploy-blocker contracts pass. Both
capabilities remain false, the challenge sheets still lack a production call
site, and no eligible evidence writer exists, so this earns no readiness point.
