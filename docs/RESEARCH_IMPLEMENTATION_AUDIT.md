...
| Hosted Firebase privacy body matches source | **Missing** | Current source is 29,237 bytes / `4cd0af64…599363c`. The last live probe targeted an older source body, and no current-source exact-body probe exists. An authorized deploy and a fresh passing probe are required. |
...
closing cross-account replay and retention proof. The reciprocal friendship
