...
| Legacy endpoint, cloud-probe, and TestFlight preflight contracts | **Proved** | 7 status-only endpoint-probe tests, 4 no-network cloud-probe scenarios, and 25 signing/TestFlight preflight tests passed. They prove local tooling behavior only. |
